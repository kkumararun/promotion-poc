package com.bby.poc.promotion.store.model;
...
import com.bby.poc.promotion.dto.CURRENCY;
import com.bby.poc.promotion.dto.RULETYPE;
...
public class DiscountRule implements IModel{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.pumpkinsafari.store.model.IModel#getId()
	 */
	@Override
	public Long getId() {
		return id;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.pumpkinsafari.store.model.IModel#setId(java.lang.Long)
	 */
	@Override
